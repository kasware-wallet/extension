...
- Refactored underlying code using @kasware/wallet-sdk.
...
- Feature
  - Add API kasware.inscribeTransfer(ticker:string, amount:string)
...
- Domain resolution related
  - Add domain name resolution of .kasware
...
- The displaying layout of NFTs in the extension is updated to match the layout on https://kasware.xyz/
