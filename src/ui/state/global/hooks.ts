...
import type { AddressType, IScannedGroup } from '@/shared/types';
import { useAppDispatch, useAppSelector } from '../hooks';
// import type { TabOption } from './reducer';
import { globalActions, selectIsBooted, selectIsReady, selectIsUnlocked, selectRpcStatus } from './reducer';
...
export function useBooted() {
  return useAppSelector(selectIsBooted);
}
export function useIsUnlocked() {
  return useAppSelector(selectIsUnlocked);
}

export function useIsReady() {
  return useAppSelector(selectIsReady);
}

export function useRpcStatus() {
  return useAppSelector(selectRpcStatus);
}
