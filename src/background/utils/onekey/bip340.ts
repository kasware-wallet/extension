...
const TAGGED_HASH_PREFIXES = {
  TapLeaf: Buffer.from([
    ...
    3, 190, 120, 233, 238, 174, 234, 143, 220, 66, 8, 152, 49, 5, 115, 75, 88, 8, 29, 30, 38, 56, 211, 95, 28, 181, 64,
    8, 212, 211, 87, 202, 3, 190, 120, 233, 238
  ]),
  ...
  TapTweak: Buffer.from([
    ...
    197, 161, 244, 175, 87, 197, 233, 232, 15, 225, 99, 156, 156, 160, 80, 227, 175, 27, 57, 193, 67, 198, 62, 66, 156,
...
export function tweakPublicKey(
  ...
  const res: { parity: number; xOnlyPubkey: Uint8Array } = ecc.xOnlyPointAddTweak(pubKey, tweakHash);
